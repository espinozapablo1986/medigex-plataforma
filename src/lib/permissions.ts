...
export const MODULOS: ModuloDef[] = [
  ...
  },
  {
    ...
    nombre: 'Odontograma',
    grupo: 'Clínico',
    descripcion: 'Ficha odontológica por pieza y cara. Desactivar en centros no dentales',
    acciones: ['ver', 'crear', 'editar', 'eliminar', 'exportar'],
  },
  {
    ...
    grupo: 'Clínico',
    descripcion: 'Examen periodontal con sondaje, margen gingival y furca',
    acciones: ['ver', 'crear', 'editar', 'eliminar', 'exportar'],
  },
  {
    slug: 'recetas',
  ...
  },
  {
    ...
    grupo: 'Comercial',
    descripcion: 'Interesados, bitácora de contactos y tareas de seguimiento',
    acciones: ['ver', 'crear', 'editar', 'eliminar', 'exportar'],
  },
  {
    slug: 'convenios',
...
export const ROLES_SEMILLA: RolSemilla[] = [
  ...
  },
  {
    ...
    permisos: {
      ...
      odontograma: ['ver', 'crear', 'editar', 'eliminar', 'exportar'],
      periodontograma: ['ver', 'crear', 'editar', 'eliminar', 'exportar'],
