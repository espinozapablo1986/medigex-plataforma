...
export default async function SinAcceso({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-tinta-100 px-4">
      <div className="tarjeta max-w-md p-8 text-center">
        <h1 className="text-lg font-semibold text-tinta-900">No tienes acceso a esta sección</h1>
